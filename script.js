 // --- Global Variables ---
        ...
        function updatePreview() {
            ...
            ctx.fillStyle = '#2d2d2d'; // Match panel bg
        ...
        function createBaitImage(mode) {
            ...
            // ERROR FIX HERE: Removed colorScalar.delete(); 
            // cv.Scalar in JS is often just an array and doesn't support explicit deletion.
